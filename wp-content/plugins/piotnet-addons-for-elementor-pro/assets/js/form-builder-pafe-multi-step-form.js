	...
	$(document).on('click','[data-pafe-form-builder-nav="next"]',function(){
		...
		$fields.each(function(){
			if ( $(this).data('pafe-form-builder-stripe') == undefined && $(this).data('pafe-form-builder-html') == undefined ) {
				...
				if ( ( !$(this)[0].checkValidity() || checked == 0 && $checkboxRequired.length > 0 ) && $(this).closest('.elementor-widget').css('display') !== 'none' && $(this).closest('[data-pafe-form-builder-conditional-logic]').css('display') != 'none' && $(this).data('pafe-form-builder-honeypot') == undefined &&  $(this).closest('[data-pafe-signature]').length == 0 || checked == 0 && $checkboxRequired.length > 0 && $(this).closest('.elementor-element').css('display') != 'none') {
					...
					console.log($(this).attr('name') + '-' + $(this).closest('.elementor-widget').css('display'));
					error++; 
				} else {
