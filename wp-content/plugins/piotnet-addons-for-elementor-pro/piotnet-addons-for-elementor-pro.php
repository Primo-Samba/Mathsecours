...
define( 'PAFE_PRO_VERSION', '6.3.31' );
define( 'PAFE_PRO_PREVIOUS_STABLE_VERSION', '6.3.26' );
update_option( 'piotnet_addons_for_elementor_pro_license', ['email'=>'email@email.ru','status'=>'A','license_key'=>'license_key','lifetime'=>true,'expired_at'=>'2030-10-10','unlimited_site'=>true, 'license_name'=>'PRO'] );

final class Piotnet_Addons_For_Elementor_Pro {

	const VERSION = '6.3.31';
	...
	public function __construct() {
		...
		$activated_license = !empty(get_option( 'piotnet_addons_for_elementor_pro_license' ));
